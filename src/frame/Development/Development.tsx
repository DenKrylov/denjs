...
export const Development = () => {
  const list = [
    ...
    [
      "САЙТ-КАТАЛОГ",
      "Электронная витрина с полным перечнем и подробным описанием товаров, предназначенная для ознакомления потенциальных клиентов с ассортиментом компании.",
    ],
    [
      "ИНТЕРНЕТ-МАГАЗИН",
      "Расширенная версия сайта-каталога с возможностью выбора и оплаты товара через сайт. Отличное решение для компаний, которые решили заняться интернет коммерцией.",
    ],
  ];
