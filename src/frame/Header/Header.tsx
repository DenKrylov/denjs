...
export const Header = () => {
  ...
  return (
    <WrapperHeader>
      ...
      <LinkListHeader>
        <ListElementHeader><LinkElementHeader onClick={() => {
          changeTheme ? localStorage.setItem('theme', 'dark') : localStorage.setItem('theme', 'dark');    
          setChangeTheme(!changeTheme)
        }}>
          <Theme />
        </LinkElementHeader></ListElementHeader>
